...
<div className="top-navigation-section">
  ...
  <div className="tabs-wrapper">
    ...
    <button
      className={activeTab === "explore" ? "tab active-tab" : "tab"}
      onClick={() => {
...
/>
      ...
      <div className="overview-text">
        ...
        <p>
          At Purplenow, we help organizations accelerate growth and gain a competitive advantage through innovative technology solutions and digital transformation services. Our expertise spans Artificial Intelligence, Generative AI, Cloud Computing, Managed Services (MSP), Cloud Solutions (CSP), Product Engineering, IoT, Data Analytics, and Enterprise Applications.

We enable businesses to modernize operations, optimize processes, and unlock the full potential of their data through intelligent, scalable, and secure solutions. From cloud adoption and application modernization to AI-driven automation and advanced analytics, we deliver technology strategies that drive measurable business outcomes.
        </p>
...
export default ObsolescenceManager;