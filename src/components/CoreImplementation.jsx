...
import coreHero from "../assets/core-hero.png";
...
<section className="info-section">
  ...
  <div className="info-top">
    ...
    <div className="info-left">
      ...
      <h2>
        Accelerate Business Growth with Expert Implementation Services
      </h2>

      <p>
       Discover how Purplenow's Implementation Services can help your organization deploy secure, scalable, and high-performance IT solutions. Our certified experts provide end-to-end implementation of Sophos Firewalls, Fortinet Security Solutions, AWS, Microsoft Azure, Google Cloud Platform, HPE Servers, and enterprise infrastructure to ensure a seamless and successful deployment.
      </p>
...
<section id="who-it-for" className="tab-section">
  ...
  <div className="tab-content">
    ...
    <p>
      Purplenow's Implementation Services are designed for organizations looking to deploy new IT infrastructure, strengthen cybersecurity, modernize data centers, or accelerate cloud adoption. Whether you're implementing Sophos or Fortinet security solutions, migrating to AWS, Azure, or Google Cloud, or deploying HPE server infrastructure, our experts ensure a smooth, secure, and efficient implementation aligned with your business objectives.
    </p>
...
<section id="how-it-works" className="tab-section">
  ...
  <div className="tab-grid">
    ...
    <div className="tab-text">
      ...
      <p>
        Our proven implementation framework ensures successful deployment with minimal disruption and maximum business value.
      </p>  
      ...
      <div className="work-card">
        ...
        <ul>
          ...
          <li>
           Understand business requirements and technical objectives.
          </li>

          <li>
           Assess existing infrastructure, applications, and security environments.
          </li>

          <li>
            Develop a detailed implementation roadmap and deployment strategy.
          </li>
      ...
      <div className="work-card">
        ...
        <ul>
          ...
          <li>
           Design secure and scalable infrastructure architectures.
          </li>

          <li>
           Deploy Sophos and Fortinet firewall solutions.
          </li>

          <li>
           Implement AWS, Microsoft Azure, and Google Cloud environments.
          </li>
  ...
  <div className="tab-content">
    ...
    <div className="feature-grid">
      ...
      <div className="feature-card">
        ...
        <p>
          Deploy and configure Sophos and Fortinet firewalls to enhance network security, visibility, and threat protection.
        </p>
      ...
      <div className="feature-card">
        ...
        <p>
        Accelerate cloud adoption with expert deployment and migration services for AWS, Microsoft Azure, and Google Cloud Platform.
        </p>
      ...
      <div className="feature-card">
        ...
        <p>
          Implement reliable HPE server solutions optimized for performance, scalability, and business-critical workloads.
</p>
  ...
  <div className="tab-content">
    ...
    <div className="feature-grid">
      ...
      <div className="feature-card">
        ...
        <p>
        Experienced professionals with expertise across Sophos, Fortinet, AWS, Azure, Google Cloud, and HPE technologies.
        </p>
      ...
      <div className="feature-card">
        ...
        <p>
          From planning and architecture design to deployment and post-implementation support, we manage the entire implementation lifecycle.
        </p>
      ...
      <div className="feature-card">
        ...
        <p>
          Every implementation is aligned with your operational requirements, security objectives, and growth plans.
        </p>
...
></div>
    ...
    <div className="env-banner-content">
      ...
      <p>
       Discover how Purplenow's Implementation Services help organizations successfully deploy secure, scalable, and future-ready IT solutions. From planning and design to deployment, testing, and go-live support, our certified experts ensure every implementation project is delivered efficiently, securely, and in alignment with your business goals.
      </p>
  ...
  <div className="newsletter-overlay">
    ...
    <div className="newsletter-container">
      ...
      <p className="newsletter-text">
        ...
        from PurplenowTechnologies and can unsubscribe at any time.
...
export default CoreImplementation;