...
import industrialHero from "../assets/industrial-hero.png";
...
>
  <div className="obsolescence-overlay"></div>
...
<section className="info-section">
  ...
  <div className="info-top">
    ...
    <div className="info-left">
      ...
      <h2>
        Accelerate Industrial Transformation with Advanced Technology Solutions
      </h2>

      <p>
        Request a Demo and discover how Purplenow helps industrial organizations accelerate digital transformation through intelligent, connected, and secure technology solutions. Our experts will assess your business needs and provide tailored recommendations across Networking, Cloud Infrastructure, Embedded Systems, Internet of Things (IoT), Data Engineering, Data Analytics, Cybersecurity, and Managed Services.
      </p>
...
<section id="how-it-works" className="tab-section">
  ...
  <div className="tab-grid">
    ...
    <div className="tab-text">
      ...
      <p>
       Our proven delivery framework helps industrial organizations accelerate digital transformation through strategic planning, seamless implementation, and continuous optimization.
      </p>
      ...
      <div className="work-card">
        ...
        <ul>
          ...
          <li>
           Understand business objectives, operational requirements, and technology challenges.
          </li>

          <li>
           Assess existing industrial systems, network infrastructure, connected assets, and data environments.
          </li>

          <li>
          Identify opportunities to improve productivity, security, operational efficiency, and innovation.
          </li>
      ...
      <div className="work-card">
        ...
        <ul>
          ...
          <li>
           Design scalable, secure, and future-ready industrial technology architectures.
          </li>
         ...
         Develop and deploy Networking, Cloud, Embedded, IoT, Data Engineering, Analytics, and Cybersecurity solutions.
          ...
          <li>
           Integrate seamlessly with existing industrial control systems, enterprise platforms, and operational technologies.
          </li>
  ...
  <div className="tab-content">
    ...
    <div className="feature-grid">
      ...
      <div className="feature-card">
        ...
        <h3>
          Industrial IoT & Smart Operations
        </h3>

        <p>
          Enable real-time asset monitoring, predictive maintenance, remote operations, and intelligent automation through advanced Industrial IoT ecosystems.
        </p>
      ...
      <div className="feature-card">
        ...
        <h3>
         Embedded Systems & Industrial Cybersecurity
        </h3>

        <p>
          Develop secure, high-performance embedded solutions while protecting industrial networks, critical infrastructure, and connected assets from evolving cyber threats.
        </p>
  ...
  <div className="tab-content">
    ...
    <div className="feature-grid">
      ...
      <div className="feature-card">
        ...
        <p>
        Deep understanding of industrial automation, manufacturing operations, smart factories, process optimization, and digital transformation initiatives.
        </p>
...
></div>
    ...
    <div className="env-banner-content">
      ...
      <h2>Comprehensive Industrial Technology Solutions</h2>

      <p>
        Empower your industrial business with Purplenow's expertise in  Cloud Infrastructure, Embedded Systems, IoT, Data Engineering, Data Analytics, Cybersecurity, and Managed Services. We help organizations build connected, secure, and intelligent industrial ecosystems that drive innovation, operational efficiency, productivity, and sustainable growth.
      </p>
