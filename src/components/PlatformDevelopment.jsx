...
import plathero from "../assets/plat-hero.jpeg";
...
function PlatformDevelopment() {
  ...
  <section
    ...
    style={{ backgroundImage: `url(${plathero})` }}
  >
  ...
  <div className="demo-container">
    ...
    <div className="demo-content">
      ...
      <div className="demo-text">
        ...
        <p>
          Schedule a personalized consultation with our embedded systems experts to discover how PurpleNow can help accelerate your product innovation and development journey. During the consultation, our team will:
        </p>

        <ul>

          <li>
            Showcase our expertise in Embedded Platform Development, Firmware Engineering, BSP Development, Device Drivers, RTOS, Linux-Based Systems, IoT Integration, and Hardware-Software Co-Design
          </li>

          <li>
           Discuss your product requirements, technical challenges, and development goals
          </li>

          <li>
           Explore customized embedded solutions designed to improve performance, reliability, scalability, and time-to-market
          </li>

          <li>
          Answer your questions and provide strategic recommendations for embedded system architecture and implementation
          </li>

        </ul>

        <p className="demo-bottom-text">
          Transform your products with advanced Embedded Platform Development solutions designed to power next-generation devices, connected systems, and intelligent applications.
        </p>
